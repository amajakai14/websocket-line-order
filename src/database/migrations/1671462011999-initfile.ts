...
export class initfile1671462011999 implements MigrationInterface {
    name = 'initfile1671462011999'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "mock_menu" ("menu_id" SERIAL NOT NULL, "menu_name" character varying NOT NULL, "menu_type" "public"."mock_menu_menu_type_enum" NOT NULL, "price" integer NOT NULL DEFAULT '0', "available" boolean NOT NULL DEFAULT true, "course_id" integer NOT NULL, CONSTRAINT "PK_74d4967d903beda77494b691fbd" PRIMARY KEY ("menu_id"))`);
